...
app.header = {
  ...
  events: function() {
    ...
    return $("header").on("mouseleave", function(e) {
      return $("header").removeClass("header--hover");
    });
  },
  nav: {
    events: function() {
...
app.modal = {
  init: function() {
    $("[data-modal-profile]").click(function(e) {
      var asesor, carrer, email, map, name, office, profile, rol, skill;
      e.preventDefault();
      name = $(this).parents(".article--people").attr("data-name");
      email = $(this).parents(".article--people").attr("data-mail");
      office = $(this).parents(".article--people").attr("data-office");
      carrer = $(this).parents(".article--people").attr("data-carrer");
      rol = $(this).parents(".article--people").attr("data-rol");
      asesor = $(this).parents(".article--people").attr("data-asesor");
...
app.testimonies = {
  init: function() {
    ...
    $(".section--testimonies").find(".section__avatar").click(function() {
      var container, index;
      index = $(this).index();
